...
void test_out_of_bounds_access() {
  ...
  access->list = list_init(max_size);
...
int main(int argc, char *argv[]) {
  ...
  DO_TEST(test_add_full)
  DO_TEST(test_list_remove_front)
