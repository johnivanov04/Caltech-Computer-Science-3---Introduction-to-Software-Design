...
polygon_t *make_square() {
  ...
  *v = (vector_t){+1, -1};
  ...
  polygon_t *poly = polygon_init(sq, (vector_t){0, 0}, 0, 0, 0, 0);
  return poly;
}
...
polygon_t *make_triangle() {
  ...
  *v = (vector_t){4, 3};
  ...
  polygon_t *poly = polygon_init(tri, (vector_t){0, 0}, 0, 0, 0, 0);
  return poly;
}
...
polygon_t *make_big_circ() {
  list_t *c = list_init(CIRC_NPOINTS);
  ...
  polygon_t *poly = polygon_init(c, (vector_t){0, 0}, 0, 0, 0, 0);
  return poly;
}
...
polygon_t *make_weird() {
  ...
  *v = (vector_t){-1, -8};
  ...
  polygon_t *poly = polygon_init(w, (vector_t){0, 0}, 0, 0, 0, 0);
  return poly;
}
