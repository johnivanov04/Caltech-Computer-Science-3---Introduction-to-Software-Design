...
// const str and const color for text_display
const char *font = "assets/Roboto-Regular.ttf";
const size_t font_size = 48;
const SDL_Color color = {0, 0, 139};
...
SDL_Texture *text_display(char *text, const char *font_path, int font_size) {
  TTF_Init();
  TTF_Font *font = TTF_OpenFont(font_path, font_size);

  SDL_Surface *surface_message = TTF_RenderText_Solid(font, text, color);
...
void text_render(SDL_Texture *Text, int x, int y, int w, int h) {
...
=======
    sdl_draw_polygon(poly, *body_get_color(body));
>>>>>>> ccbc336556a3368aa4c3a9a1a241b2f6d0f626a3
    list_free(shape);
  }
  sdl_show();
}
