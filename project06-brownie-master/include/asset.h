...
/**
 * Function to check if a click occurs inside the bounds of the button
 *
 * @param button the pointer to the button asset
 * @param click_x the x position of the mouse click
 * @param click_y the y position of the mouse click
 */
bool withinBounds(asset_t *button, double click_x, double click_y);
