...
/**
 * Alias for response_text_format(code, MIME_HTML, body) which unwraps the
 * returned bytes back into a `char *`.
 */
 ...
 */
bytes_t *response_type_format(response_code_t code, mime_type_t type, const void *body);
